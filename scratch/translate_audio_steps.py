...
def postprocess_text(v, orig_v):
    ...
    # Preserve double newlines explicitly if we had them but they got compressed
    if '\n\n' in orig_v and '\n\n' not in v:
        # try to fix it if they were replaced by single \n
        v = v.replace('\n', '\n\n')
        
    # Check if original was all-caps in sections
    # Keep uppercase tags if the original was uppercase
...
def main():
    print("STARTING AUDIO CUTTER STEPS TRANSLATION")
    ...
    for idx, filename in enumerate(all_files):
        ...
        # Ensure target_data["audio_cutter_page"] exists
