...
def main():
    print("STARTING AUDIO CUTTER REVIEWS TRANSLATION")
    ...
    for idx, filename in enumerate(all_files):
        ...
        # For batching 26 keys, it's quite large. We will split it in two chunks of 13 keys to prevent length issues
        translated = {}
        chunk_size = 13
