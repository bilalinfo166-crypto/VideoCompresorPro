...
def main():
    print("STARTING RELATED TOOLS TRANSLATION")
    ...
    en_items = [(k, en_data["tools"][k]) for k in keys_to_translate]
    ...
    for idx, filename in enumerate(all_files):
        ...
        translated = {}
        # Since it's only 8 keys, we can do them all in a single batch!
