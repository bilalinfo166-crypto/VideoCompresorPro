  ...
  return (
    <div className="flex flex-col transition-colors duration-300">
      ...
      <section className="relative pt-4 sm:pt-6 pb-12 sm:pb-20 overflow-hidden bg-[var(--background)]">
        ...
        {/* Premium soft glows using homepage styles but accented for TikTok */}
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-pink-500/5 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute top-20 right-1/4 w-[500px] h-[500px] bg-cyan-500/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      {/* Zigzag features section with customized TikTok illustration */}
