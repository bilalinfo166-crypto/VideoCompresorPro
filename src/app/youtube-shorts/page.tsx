  ...
  return (
    <div className="flex flex-col transition-colors duration-300">
      ...
      <section className="relative pt-4 sm:pt-6 pb-12 sm:pb-20 overflow-hidden bg-[var(--background)]">
        ...
        {/* Premium soft glows using homepage styles but accented for YouTube */}
      ...
      {/* Zigzag features section with customized YouTube Shorts illustration */}
      <Features context="YouTube Shorts" />
      <FeatureGrid />
      <UseCases />
      <HowItWorks />
      
      <WhyChoose 
        title={t("shorts_page.why_choose_title")} 
        description={t("shorts_page.why_choose_desc")} 
