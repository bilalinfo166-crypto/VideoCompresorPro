  ...
  return (
    <div className="flex flex-col transition-colors duration-300">
      ...
      <section className="relative pt-4 sm:pt-6 pb-12 sm:pb-20 overflow-hidden bg-[var(--background)]">
        ...
        {/* Premium soft glows using homepage styles but accented for Reels */}
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-purple-500/5 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute top-20 right-1/4 w-[500px] h-[500px] bg-orange-500/5 rounded-full blur-[120px] pointer-events-none" />
          ...
          <div className="max-w-4xl mx-auto bg-slate-50/50 dark:bg-slate-900/40 rounded-[2rem] p-6 sm:p-8 border border-[var(--card-border)] backdrop-blur-sm shadow-sm transition-all hover:shadow-md">
            ...
            <div className="flex flex-wrap gap-x-10 gap-y-5">
              {[
                ...
                { id: "why-choose", label: "Why Choose Us", icon: Shield, color: "text-indigo-500" },
                { id: "reviews", label: "User Reviews", icon: Star, color: "text-pink-500" },
      ...
      {/* Zigzag features section with customized Instagram Reels illustration */}
      <Features context="Instagram Reels" />
      <FeatureGrid />
      <UseCases />
      <HowItWorks />
      
      <WhyChoose 
        title={t("reels_page.why_choose_title")} 
        description={t("reels_page.why_choose_desc")} 
