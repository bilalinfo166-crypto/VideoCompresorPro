...
export function VideoCompressor() {
  ...
  const handleCompress = async () => {
    ...
    const result = await executeCommand(file, args);
    if (result) {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-[var(--card-border)] shadow-xl min-h-[500px] flex flex-col relative overflow-hidden group">
          {!file ? (
            <div 
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[var(--foreground)] mb-2">Drag and drop a video file to start</h3>
            ...
            <div className="flex-1 flex flex-col p-6">
              <div className="relative flex-1 bg-black rounded-2xl overflow-hidden shadow-2xl group">
        ...
        {/* BOX B: Settings */}
        <div className={`bg-white dark:bg-slate-900 rounded-[32px] border border-[var(--card-border)] shadow-xl min-h-[500px] p-8 flex flex-col transition-all duration-500 ${!file ? 'opacity-50 grayscale pointer-events-none' : 'opacity-100 grayscale-0'}`}>
